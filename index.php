...
?>
		<div class="row">
          ...
          <marquee bgcolor="blue" style="font-family:arial; font-size:20px; color:#ffffff;" behavior="alternate" onmouseover="this.stop()" onmouseout="this.start()">Selamat Datang <?php echo $_SESSION["nama_pengguna"] ?> di Aplikasi Bengkel Mobil Pekanbaru</marquee>
