...
<html lang="en">
  <head>
    ...
    <title>BENGKEL MOBIL PEKANBARU</title>
	...
	<nav class=" navbar navbar-default navbar-static-top">
	  <div class="container">
		...
		<div class="navbar-header">
		  <a class="navbar-brand">BENGKEL MOBIL PEKANBARU</a>
		</div>
		...
		<div class="row">
		  ...
		  <div class="col-xs-12 col-sm-4 col-md-4">
		  	...
		  	<div style="margin-top: 100px;" class="panel panel-default"><div class="panel-body">
		  		<div class="text-center"><h4><img src="images/bengkeldeal.jpeg" class="img-responsive"></h4></div>
		  		<form method="post">
