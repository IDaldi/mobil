...
<form method="post">
	...
	?>
            ...
            <td style="vertical-align:middle;"><?php echo $row['NoPolisi'] ?></td>
            ...
            <td class="text-center" style="vertical-align:middle;">
    		  ...
    		  <a href="laporanperinvoice.php?id=<?php echo $row['id_pembelian'] ?>" class="btn btn-success"><span class="glyphicon glyphicon-file" aria-hidden="true"></span></a>
    	    </td>
