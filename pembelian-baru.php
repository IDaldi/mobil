...
?>
		...
		<div class="panel-body">
			    ...
			    <form method="post" action="pembelian-baru.php" >
				  ...
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control" id="dtgl_beli" name="tgl_beli" readonly value="<?php echo $date = date('Y-m-d'); ?>" required >
				  </div>
